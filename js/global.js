(function($) {
  $(document).ready(function() {
    ...
    $(".popupshow").on("click", function(e) {
      ...
      if ($(popupid).hasClass("popupvideo")) {
        try {
          $(popupid + " .vjs-big-play-button").click();
        } catch (e) {}
      }
      ...
      if ($(this).is(".exit")) {
        ...
        $(".popupoverlay.exit").addClass("popupactive");
        if ($(".popupoverlay.exit").hasClass("popupactive")) {
          try {
